...
| `secviz.js` | Bandas generativas por sección (canvas de píxeles, sin dependencias): cada motivo opera la lógica de su sección — pulsos hacia el centro, recorrido del dato, marcos vacíos, barras del mercado, barrido de la tabla, compuertas del método. Se detienen fuera de pantalla y respetan `prefers-reduced-motion` |
